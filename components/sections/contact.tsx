        ...
        <div className="mt-12 flex flex-wrap justify-center gap-4">
          ...
          <a href="mailto:your-email@example.com">
            <Button
              variant="outline"
              size="lg"
              className="rounded-full border-white/10 bg-white/5 px-8 py-6 text-sm font-medium text-white transition-all hover:bg-white hover:text-black active:scale-95"
            >
              Send an Email
