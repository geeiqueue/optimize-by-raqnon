...
export default function Hero() {
  return (
    <section className="relative isolate overflow-hidden border-b border-slate-800 bg-[#070b12] text-white">
      {/* Masking overlay to soften background lines across the text areas */}
      ...
      <div className="relative z-20 mx-auto grid min-h-[calc(100vh-80px)] max-w-7xl items-center gap-10 px-6 py-12 lg:grid-cols-[1.15fr_0.85fr] lg:px-8">
        <div>
          ...
          {/* Cleaned up eye-friendly heading tracking layout */}
          <h1 className="mt-6 text-4xl font-extrabold tracking-tight text-slate-100 md:text-5xl lg:text-6xl leading-[1.15]">
          ...
          <p className="mt-6 max-w-xl text-base font-medium text-slate-300">
          ...
          <div className="mt-8 flex flex-wrap gap-4">
            ...
            <a
              href="#projects"
              className="inline-flex h-12 items-center justify-center rounded-full border border-white/20 px-8 text-sm font-medium text-white transition-colors hover:bg-white hover:text-black"
            >
              View Projects
          ...
          <div className="mt-5 space-y-3.5">
            {process.map((step) => (
              <div key={step} className="flex items-center gap-3">
                <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full border border-white/10 bg-white/5 text-slate-300">
